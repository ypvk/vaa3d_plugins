...
class ImageUtils
{
  ...
  public:
    ...
    static double getImageAveValue(unsigned char* data, V3DLONG dimx, V3DLONG dimy, V3DLONG dimz);
    static double getImageStdValue(unsigned char* data, V3DLONG dimx, V3DLONG dimy, V3DLONG dimz);
    static double fitRadiusePercent(unsigned char* data, V3DLONG dimx, V3DLONG dimy, V3DLONG dimz);
    static double fitPosition(unsigned char* data, V3DLONG dimx, V3DLONG dimy, V3DLONG dimz); 
    //get special block value
    static double getBlockMaxValue(unsigned char* data, V3DLONG dimx, V3DLONG dimy, V3DLONG dimz, V3DLONG x0, V3DLONG y0, V3DLONG z0, int xstep, int ystep, int zstep);
